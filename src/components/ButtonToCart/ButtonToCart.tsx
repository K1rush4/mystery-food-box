      ...
      <div className={"flex justify-center md:justify-start items-center"}>
        <button
          className={`rounded-l-full ${inMainPage ?
            "text-[15px] md-home:text-[20px] xl-home:text-[25px] w-[35px] h-[35px] md-home:h-[50px] xl-home:h-[60px]" :
        ...
        <button
          className={`rounded-r-full ${inMainPage ?
            "text-[15px] md-home:text-[20px] xl-home:text-[25px] w-[35px] h-[35px] md-home:h-[50px] xl-home:h-[60px]" :
            "text-2xl md:text-3xl xl:text-4xl w-10 h-10 md:h-[50px] xl:h-[60px] pr-3"}`}
          style={{backgroundColor: inMainPage ? "white" : "moccasin"}}
          onClick={() => {
            setItemInCard(itemInCard + 1)
          }}>
